...
## How to Switch to Lava Mainnet in Cosmos Wallets

Switching to the Lava Mainnet in wallets such as Keplr involves adding the network settings manually. Follow these steps:

### Keplr Wallet

1. **Visit Keplr Chains**: Go to [Keplr Chains](https://chains.keplr.app).
2. **Search for "Lava"**: Type "Lava" in the search bar and click on [Add to Keplr] to add Lava to your wallet.
3. **Open Keplr Wallet**: Launch your Keplr wallet and navigate to the "Manage Chain Visibility" section in the menu.
4. **Search and Select "Lava"**: Enter "Lava" in the search bar within the "Manage Chain Visibility" section and select it from the list.
5. **Confirm Changes**: Click on [Save] to confirm the changes.
...
:::info experimental 
Keplr wallet support in Lava Testnet is currently experimental.
:::
...
window.keplr.experimentalSuggestChain({
    ...
    "chainSymbolImageUrl": "https://cdn.prod.website-files.com/642c9c8327126062770bfdd0/66a79d609dd00c4c45130b24_Logo%20icon%20color.png",
    ...
    currencies: [ 
        { 
            ...
            coinDecimals: 6,
            coinGeckoId: "lava",
            "coinImageUrl": "https://cdn.prod.website-files.com/642c9c8327126062770bfdd0/66a79d60edc991d9b01088a4_Logo%20symbol%20color.png",
        }, 
    ],
    feeCurrencies: [
        {
...
<button style={{
        ...
        }} onClick={() => addKeplr()}>Add Lava Testnet to Keplr</button>
</p>
...
8. You will now have a Lava Testnet address copied to your clipboard, resembling: `lava@11223344556677889900aabbccddeeff1122334`.

### Leap Wallet {#leap}

:::info experimental 
Lava's Testnet support for the Leap wallet is experimental.
:::
...
<button style={{
          ...
          borderRadius: '5px', // Adjust border radius if needed
          fontSize: '16px', // Adjust font size
        }} onClick={() => addLeap()}>Add Lava Testnet to Leap</button>
</p>
...
7. Your Lava Testnet address will be copied to the clipboard, looking like: `lava@11223344556677889900aabbccddeeff1122334`
