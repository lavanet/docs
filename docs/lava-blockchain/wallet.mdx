...
2. Click on the profile icon at the top right corner and select `Add Network`.
3. Enter the following details in the network configuration:

    - **Network Name**: Lava Mainnet
    - **RPC URL**: [https://lava.tendermintrpc.lava.build:443](https://lava.tendermintrpc.lava.build:443)
    - **Chain ID**: `lava-mainnet-1`
    - **Currency Symbol**: `LAVA`
    - **REST URL**: [https://lava.rest.lava.build:443](https://lava.rest.lava.build:443)
    - **Explorer URL**: (if available)

4. Save the settings.
5. Select the Lava Mainnet from your network list to switch.

**Note**: Ensure that you replace the RPC and REST URLs with the correct ones if they change.
