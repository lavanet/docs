---
slug: /berachain
title: Berachain x Lava
---

import RoadmapItem from '@site/src/components/RoadmapItem'

![Berachain Logo](/img/chains/berachain_logo.svg)
...
https://raw.githubusercontent.com/lavanet/lava/refs/heads/main/specs/testnet-2/specs/bera.json
...
```bash
lavad q spec show-chain-info BERA
```
