...
|-----------------|------------------------------------------------|----------|-------- |
| 🌐 RPC          | <https://lava-archive.lavanet.xyz:443>         | HTTP/1.1 | Archive |
...
Official endpoint with Lava over Lava:

```bash
curl -X GET -H "Content-Type: application/json" https://lava.rest.lava.build/cosmos/base/tendermint/v1beta1/blocks/latest
```
