---
slug: /testnet-lavavisor-services
title: Testnet Service Manager
---
...
# **Testnet LavaVisor Service Manager**
...
:::info 
We improved the rpc calls intervals in recent patches so we recommend using the [`lavavisor wrap` or `pod` commands](/testnet-lavavisor-wrap#services) instead of the service manager command. This is still applicable even for multiple services.
