...
### using lavad to check your provider
...
# lavad test rpcprovider --from provider1_us --node https://public-rpc.lavanet.xyz:443/rpc/
...
# lavad test rpcprovider --from provider1_us --endpoints "provider-public-grpc:port,jsonrpc,ETH1 provider-public-grpc:port,rest,LAV1" --node https://public-rpc.lavanet.xyz:443/rpc/ 
