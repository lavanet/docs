...
# lavap test rpcprovider --from provider1_us --node https://lava-api.w3coins.io:443/rpc/
...
lavap tx pairing stake-provider LAV1 \
  "50000000000ulava" \
   ...
   "validator_lava_address" \
    ...
    --gas="auto" \
    --gas-adjustment "1.5" \
    --node "https://lava-api.w3coins.io:443/rpc/"
```
...
lavap tx pairing unstake-provider LAV1 \
   "validator_lava_address" \
    ...
    --gas="auto" \
    --gas-adjustment "1.5" \
    --node "--node https://lava-api.w3coins.io:443/rpc/"
```
